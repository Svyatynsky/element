    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".slider-popular")) new core(".slider-popular", {
                ...
                slidesPerView: "auto",
                navigation: {
                    prevEl: ".controll__arrow_prev",
                    nextEl: ".controll__arrow_next"
                },
                breakpoints: {
                    375: {
                        slidesPerView: "auto",
            ...
            if (document.querySelector(".slider-product__sliders")) {
                new core(".slider-product__slider-main", {
                    ...
                    thumbs: {
                        swiper: {
                            el: ".slider-product__thumbs",
                            slidesPerView: 3
                        }
                    },
                    navigation: {
                        prevEl: ".main-slider-product__arrow_prev",
                        nextEl: ".main-slider-product__arrow_next"
                    },
                    on: {}
                });
                new core(".slider-product__thumbs", {
                    modules: [ Thumb ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 3,
            ...
            if (document.querySelector(".main-production__slider")) new core(".main-production__slider", {
                modules: [ Thumb ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                thumbs: {
                    swiper: {
                        el: ".production-catalog-thumbs__slider",
                        slidesPerView: "auto"
                    }
                },
                on: {}
            });
            if (document.querySelector(".production-catalog-thumbs__slider")) new core(".production-catalog-thumbs__slider", {
                modules: [ Thumb ],
                observer: true,
                observeParents: true,
                spaceBetween: 24,
